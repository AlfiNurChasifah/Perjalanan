					...
					<ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
						...
						<li class="nav-item">
							<a href="historyperjalanan.php" class="nav-link align-middle px-0 text-white">
								<i class="fs-4 bi-calendar2-week"></i> <span class="ms-1 d-none d-sm-inline">Catatan Perjalanan</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="perjalanan.php" class="nav-link align-middle px-0 text-white">
								<i class="fs-4 bi-layout-text-sidebar-reverse"></i> <span class="ms-1 d-none d-sm-inline">Isi Data Perjalanan</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="catatan_lokasi.php" class="nav-link align-middle px-0 text-white">
								<i class="fs-4 bi-heart-half"></i> <span class="ms-1 d-none d-sm-inline">catatan lokasi</span>
							</a>
						</li>
						<li class="nav-item">
...
sebesar 4 kolom-->
 ...
 <marquee width="345" height="50"><h1>Add Lokasi</h1></marquee>
 <hr>
